...
EXAM_COMING_SOON = ["🏛️ GPSC", "🇮🇳 UPSC", "👮 Police Constable"]  # shown as locked, wired up later
...
#  BUTTON HANDLER
# ══════════════════════════════════════════════════════════════════════════════
def ai_exam_keyboard():
    return InlineKeyboardMarkup([
        [InlineKeyboardButton(EXAM_CONFIG["neet"]["label"], callback_data="ai_exam_neet"),
         InlineKeyboardButton(EXAM_CONFIG["gseb"]["label"], callback_data="ai_exam_gseb")],
        [InlineKeyboardButton(EXAM_CONFIG["jee"]["label"], callback_data="ai_exam_jee"),
         InlineKeyboardButton(EXAM_CONFIG["gujcet"]["label"], callback_data="ai_exam_gujcet")],
        [InlineKeyboardButton(f"🔒 {s}", callback_data="ai_exam_soon") for s in EXAM_COMING_SOON],
...
def notes_exam_keyboard():
    return InlineKeyboardMarkup([
        [InlineKeyboardButton(EXAM_CONFIG["neet"]["label"], callback_data="notes_exam_neet"),
         InlineKeyboardButton(EXAM_CONFIG["gseb"]["label"], callback_data="notes_exam_gseb")],
        [InlineKeyboardButton(EXAM_CONFIG["jee"]["label"], callback_data="notes_exam_jee"),
         InlineKeyboardButton(EXAM_CONFIG["gujcet"]["label"], callback_data="notes_exam_gujcet")],
        [InlineKeyboardButton(f"🔒 {s}", callback_data="notes_exam_soon") for s in EXAM_COMING_SOON],
...
async def button_handler(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    # ── AI Test Generator flow (NEET / GSEB / JEE Mains / GUJCET) ──
    elif query.data == "mode_ai_neet":
        user_mode[uid] = "ai_neet"
        ai_prefs[uid] = {"step": "exam"}
        await query.edit_message_text(
            "🧬 *AI Test Generator*\n\n*Step 1/4 — Exam choose karo:*",
            parse_mode=ParseMode.MARKDOWN, reply_markup=ai_exam_keyboard())

    elif query.data == "ai_exam_soon":
        await query.answer("🔒 Ye exam type jaldi aa raha hai! Abhi NEET/GSEB/JEE/GUJCET use karo.", show_alert=True)
    ...
    # ── AI Notes Generator flow ──
        ...
        await query.edit_message_text(
            ...
            parse_mode=ParseMode.MARKDOWN, reply_markup=notes_exam_keyboard())

    elif query.data == "notes_exam_soon":
        await query.answer("🔒 Ye exam type jaldi aa raha hai! Abhi NEET/GSEB/JEE/GUJCET use karo.", show_alert=True)
