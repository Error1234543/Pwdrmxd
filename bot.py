...
ALLOWED_GROUPS = [-1002645387857, -1003126293720]
FORCE_CHANNEL = "nexushubxd"
...
# ══════════════════════════════════════════════════════════════════════════════
#  NEET GENERATOR — Merged from app.py
# ══════════════════════════════════════════════════════════════════════════════
...
NEET_MODEL_POOL = ["mistral-large", "mistral-medium-3-5"]
NEET_RATE_LIMIT_GAP = 6.5
NEET_COOLDOWN_SECONDS = 120

_neet_key_index = 0
_neet_last_call = 0.0
_neet_model_cooldown = {}
...
def main():
    ...
    # Callbacks: NEET first, then generic
    ...
    # Text handlers: NEET topics first, then original
